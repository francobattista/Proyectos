...
const readline = require('readline');
    ...
    var startGame = async function () { //Explicacion: Aca necesito un async await porque estoy llamando a startGame, entonces si no la hago async va a pasar de largo por mas que pideDatos es promise
            iniciaJugador1();           //El await me para el carro del while, y hace que no lo siga ejecutando. La promesa hace que se ejecuta el then cuando obtengo la respuesta
            while(!endOfGame)
            {
